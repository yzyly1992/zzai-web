<script>
    ...
    function sendEmail() {
        ...
        const body = `I found this page and thought you might like it. ${$page.url.pathname}`;
    ...
    <div class="menu">
        ...
        {#if openShare === true}
            <div class="share" role="group">
                ...
                <hr>
                <a href="https://www.facebook.com/sharer/sharer.php?u={$page.url.pathname}" target="_blank" rel="noopener noreferrer" aria-label="Share on Facebook">
                ...
                <!-- share to linkedin -->
                <a href="https://www.linkedin.com/sharing/share-offsite/?url={$page.url.pathname}" target="_blank" rel="noopener noreferrer" aria-label="Share on LinkedIn">
                ...
                <!-- share to twitter-x -->
                <a href="https://twitter.com/intent/tweet?url={$page.url.pathname}" target="_blank" rel="noopener noreferrer" aria-label="Share on Twitter">
